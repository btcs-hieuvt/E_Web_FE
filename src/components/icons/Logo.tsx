...
const Logo = () => {
  return (
    <svg
      height="30"
      viewBox="0 0 221.59 52.38"
      role="img"
      aria-label="Corsair"
      aria-labelledby="corsair-logo-img"
    >
      <path
        fill="#FFFFFF"
      ...
      <path
        fill="#FFFFFF"
        d="M185.52,29.39h3.31l8.93,20.45H194l-2.06-4.9h-9.6l-2.09,4.9h-3.65Zm5.11,12.38-3.51-8.12-3.48,8.12Z"
        transform="translate(-13.93 -13.5)"
      ></path>
      <path
        fill="#FFFFFF"
        d="M205.36,29.53h3.56V49.84h-3.56Z"
        transform="translate(-13.93 -13.5)"
      ></path>
      <path
        fill="#FFFFFF"
      ...
      <path
        fill="#FFFFFF"
        d="M43.47,13.5S47.79,22.27,47,25.93c0,0,11.27,3.64,12.52,9.65C59.52,35.58,65.69,27.46,43.47,13.5Z"
        transform="translate(-13.93 -13.5)"
      ></path>
      <path
        fill="#FFFFFF"
        d="M39.13,26.66A39.68,39.68,0,0,1,41.37,34L35,31.59c.59-3.9-3.2-9.83-3.2-9.83Z"
        transform="translate(-13.93 -13.5)"
      ></path>
      <path
        fill="#FFFFFF"
        d="M27.73,32.7A46,46,0,0,1,29.68,39l-5.8-1.44c.6-3.9-3.08-8.62-3.08-8.62Z"
        transform="translate(-13.93 -13.5)"
      ></path>
      <path
        fill="#FFFFFF"
        ...
        transform="translate(-13.93 -13.5)"
      ></path>
      <title id="corsair-logo-img">Corsair</title>
    </svg>
  );
};
